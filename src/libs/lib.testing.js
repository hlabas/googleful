 ...
 * @param {string=} opt_message The message to include in the error.
 */
function assertNotEquals_(unexpected, actual, opt_message) {
  if (unexpected == actual) {
    var message = opt_message || 'The values should not be equal.';
    message += ' (Expected not to be: "' + unexpected + '", Actual: "' +
        actual + '")';
    throw new Error(message);
  }
}
