...
/**
 * @fileoverview Contains the OAuthService class.
 */
 ...
 * @private
 */
OAuthService.EXPIRATION_BUFFER_SECONDS_ = 60;
 ...
 * @return {OAuthService} This service, for chaining.
 */
OAuthService.prototype.setAuthorizationBaseUrl = function(authorizationBaseUrl) {
 ...
 * @return {OAuthService} This service, for chaining.
 */
OAuthService.prototype.setTokenUrl = function(tokenUrl) {
 ...
 * @return {OAuthService} This service, for chaining.
 */
OAuthService.prototype.setTokenFormat = function(tokenFormat) {
 ...
 * @return {OAuthService} This service, for chaining.
 */
OAuthService.prototype.setTokenHeaders = function(tokenHeaders) {
 ...
 * @return {OAuthService} This service, for chaining.
 */
OAuthService.prototype.setTokenPayloadHandler = function(tokenHandler) {
 ...
 * @return {OAuthService} This service, for chaining.
 */
OAuthService.prototype.setCallbackFunction = function(callbackFunctionName) {
 ...
 * @return {OAuthService} This service, for chaining.
 */
OAuthService.prototype.setClientId = function(clientId) {
 ...
 * @return {OAuthService} This service, for chaining.
 */
OAuthService.prototype.setClientSecret = function(clientSecret) {
 ...
 * @return {OAuthService} This service, for chaining.
 */
OAuthService.prototype.setPropertyStore = function(propertyStore) {
 ...
 * @return {OAuthService} This service, for chaining.
 */
OAuthService.prototype.setCache = function(cache) {
  this.cache_ = cache;
  return this;
};
 ...
 * @return {OAuthService} This service, for chaining.
 */
OAuthService.prototype.setScope = function(scope, opt_separator) {
 ...
 * @return {OAuthService} This service, for chaining.
 */
OAuthService.prototype.setParam = function(name, value) {
 ...
 * @return {OAuthService} This service, for chaining.
 */
OAuthService.prototype.setPrivateKey = function(privateKey) {
 ...
 * @return {OAuthService} This service, for chaining.
 */
OAuthService.prototype.setIssuer = function(issuer) {
  this.issuer_ = issuer;
  return this;
};
 ...
 * @return {OAuthService} This service, for chaining.
 */
OAuthService.prototype.setSubject = function(subject) {
 ...
 * @return {OAuthService} This service, for chaining.
 */
OAuthService.prototype.setExpirationMinutes = function(expirationMinutes) {
 ...
 */
OAuthService.prototype.getAuthorizationUrl = function() {
  validate_({
    'Client ID': this.clientId_,
    'Script ID': this.scriptId_,
    // HLA: deactivated for matching Contentful's stale support for OAuth2
 ...
 */
OAuthService.prototype.handleCallback = function(callbackRequest) {
 ...
 */
OAuthService.prototype.hasAccess = function() {
 ...
 */
OAuthService.prototype.getLastError = function() {
 ...
 * @return {Exception} An error, if any.
 */
OAuthService.prototype.getRedirectUri = function() {
 ...
 * @private
 */
OAuthService.prototype.getTokenFromResponse_ = function(response) {
 ...
 * @private
 */
OAuthService.prototype.parseToken_ = function(content) {
  var token;
 ...
 */
OAuthService.prototype.refresh = function() {
  validate_({
    'Client ID': this.clientId_,
    'Client Secret': this.clientSecret_,
    'Token URL': this.tokenUrl_
 ...
 * @private
 */
OAuthService.prototype.saveToken_ = function(token) {
  validate_({
    'Property store': this.propertyStore_
  });
 ...
 * @private
 */
OAuthService.prototype.getToken_ = function() {
  validate_({
    'Property store': this.propertyStore_
  });
  var key = this.getPropertyKey_(this.serviceName_);
 ...
 * @private
 */
OAuthService.prototype.getPropertyKey_ = function(serviceName) {
 ...
 * @private
 */
OAuthService.prototype.isExpired_ = function(token) {
  ...
  if (!expires_in) {
    ...
    return expires_time - now < OAuthService.EXPIRATION_BUFFER_SECONDS_;
  }
};
 ...
 * access token.
 */
OAuthService.prototype.exchangeJwt_ = function() {
  validate_({
    'Token URL': this.tokenUrl_
  });
 ...
 * @private
 */
OAuthService.prototype.createJwt_ = function() {
  validate_({
